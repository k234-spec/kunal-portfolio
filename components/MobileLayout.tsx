  ...
  return (
    <div className="min-h-screen bg-bg text-text w-full overflow-x-hidden pt-[60px]">
      ...
      <section id="hero" className="px-6 py-20 flex flex-col items-center text-center">
        <div className="w-[120px] h-[120px] rounded-full overflow-hidden bg-surface-2 mb-6 relative">
          <Image src="/photo.png" alt="Kunal Mangla" fill sizes="120px" className="object-cover" onError={(e) => { (e.target as HTMLImageElement).src = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="120" height="120"><rect width="120" height="120" fill="%23181818"/></svg>'}} />
        </div>
